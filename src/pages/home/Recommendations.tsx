    ...
    const fetchRecommendations = async () => {
      try {
        const response = await ky
          .get(`${import.meta.env.VITE_BASE_URL}/api/recommendations`, {
              ...
              books.map(async (book) => {
                try {
                  const kakaoResponse = await ky
                    .get(`https://dapi.kakao.com/v3/search/book?target=isbn&query=${book.isbn13}`, {
                      headers: {
                        Authorization: `KakaoAK ${import.meta.env.VITE_KAKAO_REST_API_KEY}`,
                      },
                    })
                    .json<{
                      documents: { title: string; authors: string[]; thumbnail: string }[];
                    }>();
    ...
    <div className="recommendations-container">
      <div className="header">
        <div className="top-row">
          <div className="logo">
            <img src="/public/icon/small3.png" alt="small-logo" className="small-logo" />
            <img src="/public/icon/Logo-text.jpg" alt="Book&Talk Logo" className="talk-logo" />
          </div>
          <img
            src="/public/icon/Logo-Notification.jpg"
        ...
        <div className="search-bar-container">
          ...
          <div className="search-icon" onClick={() => {}}>
            <img src="/public/icon/Logo-search.jpg" alt="Search Icon" />
          </div>
        </div>
      </div>
