...
const GroupForm = () => {
  ...
  const handleChange =
    (input: keyof FormData) => (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
  ...
  return (
    <div className="meeting-creation-container">
      ...
      {step === 5 && (
        <Step6 prevStep={prevStep} book={book} formData={formData} setFormData={setFormData} />
      )}
    </div>
  );
};
